...
if ( ! class_exists( 'CFRID_Module_CF7' ) ) {
    class CFRID_Module_CF7 {
        ...
        public function check_cf7_plugin() {
            ...
            echo '<p>' . sprintf( __( "You need to install/activate %s Contact Form 7%s plugin to use %s CF7 Integrations %s", CFRID_TEXTDOMAIN ), '<a href="http://contactform7.com/" target="_blank">', '</a>', '<strong>', '</strong>' );
            ...
            echo '. <a href="' . admin_url( $url ) . '">' . __( "Do it now?", CFRID_TEXTDOMAIN ) . '</a></p>';
            echo '</div>';
        }
        ...
        public function wpcf7_editor_panels( $panels ) {
            $panels['webhook-panel'] = array(
                'title'     => __( 'Make (Integromat)', CFRID_TEXTDOMAIN ),
        ...
        public function wpcf7_skip_mail( $skip_mail, $contact_form ) {
            ...
            if ( $this->can_submit_to_integromat( $contact_form ) ) {
        ...
        public function wpcf7_mail_sent( $contact_form ) {
            ...
            try {
                 ...
                 * We send it using CFRID_Module_Integromat::pull_the_trigger().
                 *
                 * @since  1.0.0
                 */
        ...
        private function get_data_from_contact_form( $contact_form ) {
            ...
            $upload_path = CFRID_UPLOAD_DIR . '/' . $contact_form->id() . '/' . uniqid();
         ...
         * @param    obj                $contact_form   ContactForm Obj
         */
        private function can_submit_to_integromat( $contact_form ) {
            $properties = $contact_form->prop( self::METADATA );
